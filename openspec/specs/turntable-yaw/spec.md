# turntable-yaw Specification

## Purpose
The base's coupled stepper pair turning a turntable and everything on it about the base's vertical axis through the worm drive.
